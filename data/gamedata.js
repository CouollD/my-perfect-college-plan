...
const CHARACTERS = [
  {
    ...
    traits:['暴走しやすい'],
    circle:'sports', living:'alone_send', part:'izakaya',
  ...
  },
  {
    ...
    traits:['静観しやすい'],
    circle:'culture', living:'home', part:'none',
    locked:false, group:'circle', tag:'サークル',
  ...
  },
  {
    ...
    traits:['譲れる'],
    circle:'culture', living:'alone_nosend', part:'cafe',
    locked:false, group:'circle', tag:'サークル',
  ...
  },
  {
    ...
    traits:['学歴厨'],
    circle:'none', living:'home', part:'juku',
  ...
  },
  {
    ...
    traits:['静観しやすい'],
    circle:'none', living:'alone_nosend', part:'izakaya',
    locked:false, group:'class', tag:'ゼミ',
    weak:'ビジュ', limit:null,
    note:'段取りは完璧。第一印象は最悪。',
  ...
  },
  {
    ...
    traits:['学歴厨'],
    circle:'culture', living:'home', part:'juku',
    locked:false, group:'class', tag:'ゼミ',
  ...
  },
  {
    ...
    traits:['静観しやすい'],
    circle:'none', living:'alone_send', part:'cafe',
    locked:false, group:'class', tag:'ゼミ',
    weak:null, limit:null,
  ...
  },
  {
    ...
    traits:['暴走しやすい'],
    circle:'sports', living:'alone_nosend', part:'izakaya',
  ...
  },
  {
    ...
    traits:['惚れっぽい'],
    circle:'culture', living:'home', part:'cafe',
    locked:false, group:'part', tag:'バイト',
    weak:'手際', limit:'月2回',
    note:'遅刻・段取り崩しリスクあり。',
  ...
  },
  {
    ...
    traits:['静観しやすい'],
    circle:'none', living:'home', part:'cafe',
    locked:false, group:'part', tag:'バイト',
  ...
  },
  {
    ...
    traits:['譲れる'],
    circle:'sports', living:'home', part:'none',
  ...
  {
    id:14, name:'有村 そうた', type:'万能・2年後半解放',
    ...
    traits:['譲れる'],
    circle:'culture', living:'alone_send', part:'juku',
    locked:true, group:'old', tag:'幼馴染',
    weak:null, limit:'2年後半に解放',
    note:'2年後半の再会イベントをクリアすると使える。',
    hint_default:'幼馴染。しばらく連絡が途絶えていた。',
    hint_friend:'昔から何でもできる人だった。今どうしてるんだろう。',
  },
];
...
const HEROINES = [
  ...
  },
  {
    ...
    traits:['暴走しやすい'],
    circle:'sports', living:'alone_send', part:'cafe',
    locked:false, group:'heroine', tag:'相手',
    weak:'頭', limit:null,
  ...
  },
  {
    ...
    traits:['惚れっぽい'],
    circle:'culture', living:'alone_nosend', part:'none',
    locked:false, group:'heroine', tag:'相手',
    weak:'手際', limit:null,
  ...
  },
  {
    ...
    traits:['惚れっぽい'],
    circle:'sports', living:'home', part:'cafe',
    locked:false, group:'heroine', tag:'相手',
    weak:null, limit:null,
...
function createNewConfig(living, circle, part, selfParams) {
  const actual = {};
